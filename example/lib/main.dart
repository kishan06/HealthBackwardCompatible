...
class _HealthAppState extends State<HealthApp> {
  ...
  style: const ButtonStyle(
    backgroundColor: MaterialStatePropertyAll<Color>(Colors.blue), // Corrected line
  ),
  child: const Text(
 ...
 Widget get _content {
  switch (_state) {
    ...
    case AppState.PERMISSIONS_REVOKING:
      return _permissionsRevoking;
    case AppState.PERMISSIONS_REVOKED:
      return _permissionsRevoked;
    case AppState.PERMISSIONS_NOT_REVOKED:
      return _permissionsNotRevoked;
    default:
      throw Exception("Unhandled AppState: $_state");
  }
}
